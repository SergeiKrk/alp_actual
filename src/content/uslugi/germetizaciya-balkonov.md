...
list_services:
  ...
  - name: '⚡ Герметизация крыши балкона'
    url_id: '#герметизация-крыши-балкона'
  - name: '⚡ Герметизация балконных козырьков'
    url_id: '#герметизация-балконных-козырьков'
...
our_service:
  ...
  list_service:
    ...
    - title: Установка козырька и наплавляемая кровля
      ...
      link: '#second_form'
    - title: Герметизация крыши балкона
      title_id: герметизация-крыши-балкона
      description: Герметизация крыши балкона - это процесс обеспечения защиты крыши балкона от влаги, осадков и других внешних воздействий. Эта услуга включает в себя ряд работ по подготовке поверхности крыши, удалению старого герметика, устранению трещин и других повреждений, а также нанесению нового герметика или гидроизоляционного покрытия.
      image: '/images/germetizaciya-kryshi-balkona.webp'
      link: '#second_form'
    - title: Герметизация балконных козырьков
      title_id: герметизация-балконных-козырьков
      description: Эта услуга напрвлена на обеспечение герметичности и защиты верхней части балкона (козырька) от влаги, осадков и других атмосферных воздействий. Она включает в себя проверку состояния козырька, устранение трещин, щелей и других дефектов, а также нанесение специальных герметизирующих материалов или покрытий для создания надежного барьера от влаги. Герметизация балконных козырьков помогает предотвратить проникновение воды в помещение через верхнюю часть балкона, что способствует сохранности конструкции и предотвращает возможные повреждения.
      image: '/images/germetizaciya-balkonnyh-kozyrkov.webp'
      link: '#second_form'
---
